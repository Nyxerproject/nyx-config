    ...
    in
    {
      nixosModules = {
        default.imports = [
          ...
          # {
          #   environment.systemPackages = [ inputs.rio.packages.${system}.rio ];

          # {
          #   home-manager.users.nyx.programs.rio = {
          #     enable = true;
          #     package = inputs.rio.packages.${system}.rio;
          #   };
          # }
          # }
        ...
        zed.imports = [
          { environment.systemPackages = [ inputs.zed-editor.packages.${system}.zed-editor ]; }
        ];
